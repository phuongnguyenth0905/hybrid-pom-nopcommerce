...
public class Level_22_Java_Faker extends AbstractTest {

	WebDriver driver;
	FakerConfig fakeData = FakerConfig.getFakerData();
	...
	public void beforeClass(String browserName, String url) {
		...
		firtName = fakeData.getFirstName();
		...
		zipCode = "625632";
		adress = fakeData.getStreetAddress();
		city = fakeData.getCity();
		phone = fakeData.getPhone();
