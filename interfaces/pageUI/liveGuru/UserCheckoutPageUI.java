...
public class UserCheckoutPageUI {
	...
	public static final String STATE_DROPDOWN_AT_BILLING_FORM = "//select[@id='billing:region_id']";
	...
	public static final String CONTIUNE_BUTTON_BY_TITLE_NAME = "//h2[text()='%s']/parent::div/following-sibling::div//span[text()='Continue']";
